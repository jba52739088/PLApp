...
public final class HHFloatingView: UIView {
    ...
    public var options = [HHFloatingViewButton]()
    fileprivate var openingCenters = [CGPoint]()
    fileprivate var currentButtonIndex = 0
    
    //MARK: Handler Button
    public var handlerButton: HHFloatingViewButton?
    
    //MARK: Configurations
    public var configurations: HHFloatingViewConfiguration!
    ...
    fileprivate func updateUI() {
        ...
        if isOpen {
            handlerButton?.setImage(configurations.handlerCloseImage, for: .normal)
        }else {
    ...
    @objc fileprivate func optionsOpenAnimation() {
        ...
        self.handlerButton?.setImage(self.configurations.handlerCloseImage, for: .normal)
